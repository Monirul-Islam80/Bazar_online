...
export const ORDER_DETAILES_REQUEST = 'ORDER_DETAILES_REQUEST'
export const ORDER_DETAILES_SUCCESS = 'ORDER_DETAILES_SUCCESS'
export const ORDER_DETAILES_FAIL = 'ORDER_DETAILES_FAIL'
